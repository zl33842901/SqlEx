...
namespace xLiAd.SqlEx.Core.Helper
{
    ...
    internal class ResolveExpression
    {
        ...
        /// </summary>
        public const string JsonColumnNameSuffix = "_SqlEx_JsonColumn";
        /// <summary>
        /// FieldAny 查询时的临时字段名称
        /// </summary>
        public const string FieldAnyColumnName = "SqlEx_FieldAny_Column";
        /// <summary>
        /// FieldAny 查询时的临时表名称
        /// </summary>
        public const string FieldAnyTableName = "SqlEx_FieldAny_Table";
