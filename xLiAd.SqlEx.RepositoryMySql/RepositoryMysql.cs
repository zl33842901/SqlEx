...
namespace xLiAd.SqlEx.RepositoryMysql
{
    public class RepositoryMysql<T> : RepositoryBase<T>, IRepositoryMysql<T>
    {
        ...
        public RepositoryMysql(IDbConnection _con, RepoXmlProvider repoXmlProvider = null, SqlEx.Core.Core.SqlExExceptionHandler exceptionHandler = null, bool throws = true)
            : base(_con, repoXmlProvider, exceptionHandler, throws)
        {

        }
        public RepositoryMysql(IDbTransaction _tran, RepoXmlProvider repoXmlProvider = null, SqlEx.Core.Core.SqlExExceptionHandler exceptionHandler = null, bool throws = true)
